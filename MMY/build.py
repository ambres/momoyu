...
# 前缀
image_prefix = 'ccr.ccs.tencentyun.com/estar/'

image_dict = {
      'mmy-api': image_prefix + 'mmy-api'
}
...
def main(argv):
    ...
    for option, value in options:
        if option in ("-h", "--help"):
            ...
            print("")
            print("-n mmy-api -t latest #构建 后台api")
        if option in ("-n", "--name"):
    ...
    # 本地 publish
    os.system("dotnet publish -r linux-x64 \"./"+path_name+"/"+path_name+".csproj\" -c Release")
    # 执行命令
